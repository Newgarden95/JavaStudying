...
<%
	...
	int productNum = Integer.parseInt(request.getParameter("productNum")); //상품번호(주소에 쓰이는거)
...
<body>
<script type="text/javascript">/* 최근방문한페이지에 대한 정보를 넘겨주기위해 사용(상품이름과 상품넘버[주소에 사용]) */
			location.href = "Arraylist_basket.jsp?name=<%=productName%>&productpage=<%=productNum%>"
</script>
