		...
		$.ajax({
			...
			*/
			...
			success: function(result) {
				...
				$("#rooming").html("<img src = 'resources/rimg/"+roomimg+"'style = 'width:900px'>")
				$("#rooming2").html("<img src = 'resources/rimg/"+roomimg2+"'style = 'width:500px; height:290px'>")
				$("#rooming3").html("<img src = 'resources/rimg/"+roomimg3+"'style = 'width:500px; height:305px'>")
			}
		})
		...
		<div id = "contentBot">
			<table>
				<tr>
					...
					<td rowspan="2" id = "rooming"></td>
					<td id = "rooming2" style="margin-top: 10px"></td>
				</tr>
				<tr>
					<td id = "rooming3"></td>
				</tr>
