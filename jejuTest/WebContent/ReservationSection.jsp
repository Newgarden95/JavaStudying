...
<nav id="Content">
	...
	<div id="Reservationleft">
		...
		<div id="leftbox">
			...
			결제방식<br>
			<input type = "radio" value ="현장결제" name ="pay">현장결제
			<input type = "radio" value ="카드결제" name ="pay">카드결제<br>
			<input type = "radio" value ="계좌이체" name ="pay">계좌이체
			<input type = "radio" value ="휴대폰결제" name ="pay">휴대폰결제<br><br>
		</div>
	</div>
