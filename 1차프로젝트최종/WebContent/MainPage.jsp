...
<html>
	...
	<nav id="Content"> <!-- 본문, 각 조원들이 넣게될 본문 레이아웃 생성 -->
			...
			<table style="width: 80%; margin-left:100px;"> <!-- 각 아이콘들의 정렬을 하기 위해서 1x4의 하나의 테이블을 만들어서 각 데이터셀에 저장 -->
				<tr>
					<td>
						<a class="cellIconBox" href="ProductSummary.jsp?classification=Hotel" > <!-- 상품요약페이지로 이동을 할떼 Hotel이라는 파라미터를 같이 넘겨줍니다. -->
							<img name="Hotel" id="HotelIcon" src="pictures/HotelIcon.png" width="100" height="100"> <!-- 가로,세로 크기 100짜리의 그림을 출력 -->
							<br>호텔
						</a>
					</td>
					<td>
