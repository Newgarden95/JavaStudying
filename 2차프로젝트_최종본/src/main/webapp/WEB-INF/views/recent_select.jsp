...
최근 본 상품 조회
<hr color="red">
<!-- 화면에 찍어줄거 상품넘버를 통해 얻어온 상품 정보들 + 찜상태 + 최근 본 시간 -->
<c:forEach var="list2" items="${list2}">
아이디: ${list2.userid} <!-- 표현언어(Expression Languages:EL), 속성프린트 --><br>
상품번호: ${list2.pnum}<a href = "productdetail.jsp?pnum=${list2.pnum}"><button style="background-color:#007bff; color: white; margin-left: 5px">이동하기</button></a><br>
상품이름: ${list2.pname}<br>
상품가격: ${list2.price}<br>
방문시간: ${list2.time2}<br>
<br>
