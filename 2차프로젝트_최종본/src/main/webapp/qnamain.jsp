...
<body>
	...
	<nav class="navbar navbar-light bg-light static-top">
		...
		<div id="menu">
			...
			<!-- href에 각자 만든 페이지 주소 넣어주기 -->
			<a class="btn btn-primary btn-lg" href="ruser_login.jsp">로그인</a> <a
				class="btn btn-primary btn-lg" href="signup.jsp">회원가입</a>
		</div>
		<div>
			<h3>1:1 문의내역</h3>
			<ul id="notice">
			...
			<a href="ruser_login.jsp" id="qnainsert">1:1 문의하기</a> <br>
		</div>
		<%
			} else {
		%>
		...
		<!-- navigation 종료 -->
		<div id="qnamain_wrap" class="text-center">
			<h3>1:1 문의내역</h3>
			<ul id="notice">
				<li>최근 6개월 이내의 문의 내역을 확인하실 수 있습니다. (2021년 3월 이전에 문의하신 내용은 이메일로
					답변을 발송하여 본 페이지에서 내역 확인이 불가합니다.)</li>
			...
			<a href="qnainsert.jsp?userid=${userid}" id="qnainsert">1:1 문의하기</a>
			<br>
		</div>
		<div>
			<h3>문의목록</h3>
			<hr>
			<a href="qall">1:1 문의내역</a><!--  <a href="admin">관리자 목록</a> -->
		</div>
		<%
			}
		%>
