...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    session.setAttribute("productsession", productpage1); //productsession : 상품페이지 주소(세션) => 상품이름으로 변경할 예정, 주소는 하이퍼링크로 달 예정
    ...
    response.sendRedirect(productpage1); //현재 방문하기 위해 눌렀던 상품페이지로 다시 돌아감
    %>
