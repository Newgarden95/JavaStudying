		...
		$.ajax({
			...
			*/
			...
			success: function(result) {
				...
				$(".rooming").html("<img src = 'resources/img/"+roomimg+"'>")
			}
		})
...
<!-- Navigation : 위에 부분-->
	...
	<div class = "content" style="padding-left: 250px; padding-right: 200px">
		<div class = "contentTop" style="width: 1405px; height: 150px; margin-top: 50px"> <!-- 크기고정 width고정시켜버림 -->
			<div class = "a">
				...
				<div class = "a">
					...
					<span class = "rsize" style="font-weight: bold"></span>
				</div>
			<div class = "a">
		...
		<div id = "contentMid" style="width: 700px">
			<div class = "b">
				해당층/건물층&nbsp&nbsp&nbsp&nbsp<span class = "floor" style="font-weight: bold"></span>
			</div>
			<div class = "b" style="margin-left: 50px">
				전용/공급면적&nbsp&nbsp&nbsp&nbsp<span class = "rsize" style="font-weight: bold"></span>
			</div>
			<div class = "b" style="margin-left: 50px">
				방수/욕실수&nbsp&nbsp&nbsp&nbsp<span class = "room" style="font-weight: bold"></span>
			</div>
			<hr>
			<div class = "b">
				난방종류&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
				<span style="font-weight: bold">개별난방</span>
			</div>
			<div class = "b" style="margin-left: 48px">
				주차대수&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		...
		<div id = "contentBot">
			<div id = "pic">
				<div class = "rooming" style="margin-left: 440px">
				</div>
			</div>
			<hr>
			<div id = "pdMap">
