 ...
 * Generated at: 2021-05-04 09:08:33 UTC
...
public final class LoginConnect_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("id") == null) { 
      out.write("   <!-- 세션값이 없을 때 -->\r\n");
      out.write("\t\t\t\t<script type =\"text/javascript\">  /* 자바 스크립트 실행  */\r\n");
      out.write("\t\t\t\t\talert(\"로그인에 실패했습니다. 아이디와 비밀번호를 다시 입력해주세요.\")   /* 로그인 실패 알림 띄우기  */\r\n");
      out.write("\t\t\t\t</script> <!-- 자바스크립트 종료 -->\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t <form action = \"LoginConnect.jsp\">   <!-- 결과값을 다시 LoginConnect로 보내주는 login창을 보여줌 -->\r\n");
      out.write("\t\t\t\t\t\r\n");
