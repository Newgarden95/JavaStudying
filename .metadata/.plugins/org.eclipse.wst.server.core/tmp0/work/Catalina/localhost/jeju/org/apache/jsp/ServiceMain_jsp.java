 ...
 * Generated at: 2021-05-04 09:09:40 UTC
...
public final class ServiceMain_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("jeju.notice_board");
 ...
 if( id == null) {	
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr> <!-- 브라우저 노출 부분 -->\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(bag.getNo() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td><a href=\"BoardDetailMain.jsp?notice_no=");
      out.print(bag.getNo());
      out.write('"');
      out.write('>');
      ...
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(bag.getDate());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(bag.getWriter() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t<td>");
      out.print(bag.getFile() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t");
if (id == null || !(id.equals("admin"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<!-- 로그인한 id에 따라서 버튼 활성화 시키기 admin만 삭제 가능-->\r\n");
      out.write("\t\t\t\t\t\t");
} else if(id.equals("admin")) {
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<td><button onclick=\"location.href='BoardDelete.jsp'\">삭제</button></td>\r\n");
      out.write("\t\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t<!-- admin 관리자 계정으로 로그인시 등록하기 활성화 -->\r\n");
      out.write("\t\t<form action=\"BoardEnroll.jsp\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t<!-- 관리자외 다른 세션 설정시 등록권한이 없습니다! -->\r\n");
      out.write("\t\t등록권한이 없습니다.\r\n");
      out.write("\t\t");
