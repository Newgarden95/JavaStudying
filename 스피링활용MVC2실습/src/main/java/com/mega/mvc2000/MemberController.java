...
public class MemberController {
	...
	@Autowired //이거 안 넣으면 nullpointException 에러 발생 ~> 왜냐면 아래 dao에 주소값이 들어가야하는데 싱글톤설정시 Autowired가 역할을함 안해놓으면 null값이 들어감
	MemberDAO dao; // 싱글톤으로 만들어진 객체의 주소를 담은 변수만들기 // 전역변수
