		...
		*/
		...
		$.ajax({
			...
			*/
			...
			var mapOption = {
				center : new kakao.maps.LatLng(37.55510837919797, 126.93680885227917), //지도의 기준점을 설정
				level : 5
			};
			...
			function paging(totalData, dataPerPage, pageCount, currentPage) {
				...
				//list에 상품들을 가져와 넣어줘야함=> 안그러면 그냥 페이징만 표시됨
							...
							for (var i = 0; i < 8; i++) { //페이지당 8개의 데이터를 출력해줘야 하기 떄문에 0~8까지로 설정
								...
								list += "<a href = 'productdetail.jsp?pnum="+pn[i]+"'><img src = 'resources/img/home.jpg' style = 'width: 200px; height: 100px'></a>"
								list += "<div>" + result[i].ctype+ "</div>"
								list += "<div>" + result[i].price+ "</div>"
